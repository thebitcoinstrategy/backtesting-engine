                ...
                <div class="rolling-results">
                    ...
                    <div class="rolling-tab-content" id="rtab-animated">
                        ...
                        <div id="anim-stack" style="position:relative;width:100%;height:600px;border-radius:12px;border:1px solid var(--border);background:var(--bg-deep);overflow:hidden">
                            <div id="plotly-anim-a" style="position:absolute;inset:0;transition:opacity 0.8s ease;opacity:1"></div>
                            <div id="plotly-anim-b" style="position:absolute;inset:0;transition:opacity 0.8s ease;opacity:0;pointer-events:none"></div>
                        </div>
...
def _run_post_handler(cancel_event):
    ...
    if p.mode == "rolling":
        ...
        # Generate windows
        try:
            import sys; print(f"[ROLLING] window_size={p.window_size} step_size={p.step_size} windows will use {p.window_size}yr window", file=sys.stderr, flush=True)
